...
if(isset($_POST['name'])) {
        ...
        if($img_erro != 4) {
            if($img_size < 1027175) {
                if(in_array($final_ext, $ext)) {
                    move_uploaded_file($tmp_name, 'upload/products/' . $imgname);
                } else {
    ...
    $stat = "insert into products (name , price , color , category_id, image) values ('$_POST[name]' , '$_POST[price]' ,'$_POST[color]' ,'$_POST[category_id]' ,'$imgname')";
              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <img src="upload/products/default_image.png" id="img-preview" width="250px" alt="" srcset="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" id="exampleInputEmail2" placeholder="Enter username">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail2">product color</label>
                    <input type="color" name="color" class="form-control" id="exampleInputEmail2" placeholder="Enter username">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">upload product</label>
